...
-- A	=>  Location: PIN_H22,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
ARCHITECTURE structure OF circuit4f IS
...
-- Equation(s):
-- \Z~0_combout\ = \E~input_o\ $ (((!\B~input_o\ & ((\C~input_o\) # (\D~input_o\)))))
